...
{
    public partial class frm_Hot_Cat_H1 : Form
    {
        ...
        private void frm_Hot_Cat_H1_Load(object sender, EventArgs e)
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            conn1.Open();
            OleDbCommand cmd1 = new OleDbCommand("select Ele_Acc_No,Cu_Name,Address,Area_Office,Mon from Cu_De_Hotel_Purpose where  Ele_Acc_No=@para1", conn1);
